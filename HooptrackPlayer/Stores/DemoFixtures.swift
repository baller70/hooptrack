...
enum DemoFixtures {
    static let snapshot = DashboardSnapshot(
        ...
        invites: [
            TeamInvite(id: 501, groupName: "Varsity Guard Group", coachName: "Coach Rivera", status: "pending")
        ],
        memberships: [
            TeamMembership(id: 601, groupName: "Summer Skill Lab", coachName: "Coach Rivera")
        ],
