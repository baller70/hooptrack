...
| Apple roles/Xcode | **BLOCKED** | No Apple Developer/App Store Connect credentials or macOS/Xcode host is attached. Roles, certificates, profiles, archives, and native CI results cannot be inspected locally. |
