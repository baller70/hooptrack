...
export default function SupportPage() {
  return (
    <PublicDocumentPage title="Hoopstrack Support">
      <section>
        <h2>Get Help</h2>
        <p className="mt-2">For account access, team invitations, recordings, privacy, safety reports, or account deletion, email our support team. Include whether you use Hoopstrack Player or Hoopstrack Coach and the email address connected to the account.</p>
        <a
          ...
          href="mailto:khouston@thebasketballfactorynj.com?subject=Hoopstrack%20Support"
        >
          Email Hoopstrack Support
        </a>
      </section>
      <section>
        <h2>Safety</h2>
